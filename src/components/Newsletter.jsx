...
import brochure from "../assets/Nimblefin_Brochure.pdf";
    ...
    <div className="w-full py-16 text-black px-4">
      <div className="max-w-[1240px] mx-auto grid lg:grid-cols-3">
        <div className="lg:col-span-2 my-4">
          ...
          <p className="italic font-semibold text-gray-700 mt-1.5">
            Subscribe to Nimblefin updates and get expert tips on claims, RCM,
            and insurance desk efficiency.
          </p>
        </div>
